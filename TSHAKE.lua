                ...
                if not is_mod(msg.sender_user_id_, msg.chat_id_) then
                    ...
                    if msgs > (floodMax - 1) then
                        ...
                        database:sadd(bhash, user_id)
                           send(msg.chat_id_, msg.id_, 1, '● - `ایدی` 📍: *'..msg.sender_user_id_..'* \n`بدلیل ارسال پیام های مکرر` ⚠️\n`از این گروه اخراج شد` ❌', 1, 'md')
					  end
                    end
...
if database:get('bot:muteallwarn'..msg.chat_id_) and not is_mod(msg.sender_user_id_, msg.chat_id_) then
        ...
        local chat = msg.chat_id_
        delete_msg(chat,msgs)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>رسانه ها قفل شده است ارسال ممنوع</code> ⚠️❌", 1, 'html')
        return 
end
...
if database:get('bot:muteallban'..msg.chat_id_) and not is_mod(msg.sender_user_id_, msg.chat_id_) then
        ...
        delete_msg(chat,msgs)
       chat_kick(msg.chat_id_, msg.sender_user_id_)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>رسانه ها قفل شده است ارسال ممنوع</code> ❌\n● - <code>تم طردك</code> ⚠️", 1, 'html')
        return 
end
...
if database:get('bot:viewget'..msg.sender_user_id_) then 
    if not msg.forward_info_ then
		send(msg.chat_id_, msg.id_, 1, '● - `باموفقیت بہ همه ارسال شد✔️', 1, 'md')
		database:del('bot:viewget'..msg.sender_user_id_)
	else
		send(msg.chat_id_, msg.id_, 1, '● - <code>تعداد مشاهده شده </code>: ↙️\n● - '..msg.views_..' ', 1, 'html')
        database:del('bot:viewget'..msg.sender_user_id_)
	end
end
if msg_type == 'MSG:Photo' then
 if not is_mod(msg.sender_user_id_, msg.chat_id_) then
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
		   chat_kick(msg.chat_id_, msg.sender_user_id_)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال عکس در گروه ممنوع می باشد</code> ❌\n● - <code>توجہ حالت مسدودسازے فعال می باشد</code> ⚠️", 1, 'html')
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال عکس در گروه ممنوع می باشد.حالت هشدار فعال می باشد</code> ⚠️❌", 1, 'html')
          return 
   end
        if msg.content_.caption_ then
   ...
   if not is_mod(msg.sender_user_id_, msg.chat_id_) then
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
       chat_kick(msg.chat_id_, msg.sender_user_id_)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال اسناد در گروه ممنوع می باشد.</code> ⚠️\n● - <code>توجہ حالت مسدودے فعال است</code> ❌", 1, 'html')
          return 
   end
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال اسناد درگروه ممنوع می باشد.حالت هشدار فعال می باشد</code> ⚠️❌", 1, 'html')
          return 
   end
   end
  ...
  elseif msg_type == 'MSG:MarkDown' then
   if not is_mod(msg.sender_user_id_, msg.chat_id_) then
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
       chat_kick(msg.chat_id_, msg.sender_user_id_)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال صفحات فروشگاهی ممنوع می باشد.</code> ⚠️\n● - <code>توجہ حالت مسدودسازے فعال می باشد</code> ❌", 1, 'html')
          return 
   end
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال صفحات فروشگاهی ممنوع می باشد.حالت هشدار فعال می باشد</code> ⚠️❌", 1, 'html')
          return 
   end
 end
  ...
  elseif msg_type == 'MSG:Inline' then
   if not is_mod(msg.sender_user_id_, msg.chat_id_) then
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
       chat_kick(msg.chat_id_, msg.sender_user_id_)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>استفاده از کیبورد شیشه اے در گروه ممنوع می باشد</code> ⚠️\n● - <code>توجہ حالت مسدودسازے فعال می باشد</code> ❌", 1, 'html')
          return 
   end
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>استفاده از کیبورد شیشه اے ممنوع می باشد.حالت هشدار فعال می باشد</code> ⚠️❌", 1, 'html')
          return 
   end
   end
  ...
  if database:get('bot:sticker:mute'..msg.chat_id_) then
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
       chat_kick(msg.chat_id_, msg.sender_user_id_)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال استیکر در گروه ممنوع می باشد</code> ⚠️\n● - <code>توجہ حالت مسدود سازے فعال می باشد</code> ❌", 1, 'html')
          return 
   end
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال استیکر درگروه ممنوع می باشد.حالت هشدار فعال می باشد</code> ⚠️❌", 1, 'html')
          return 
   end
   end
 ...
 if not is_mod(msg.sender_user_id_, msg.chat_id_) then
  if database:get('bot:contact:mute'..msg.chat_id_) then
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
       chat_kick(msg.chat_id_, msg.sender_user_id_)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال مخاطب در گروه ممنوع می باشد</code> ⚠️\n● - <code>توجہ حالت مسدودسازے فعال می باشد</code> ❌", 1, 'html')
          return 
   end
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال مخاطب در گروه ممنوع می باشد.حالت هشدار فعال می باشد</code> ⚠️❌", 1, 'html')
          return 
   end
   end
 ...
 if not is_mod(msg.sender_user_id_, msg.chat_id_) then
  if database:get('bot:music:mute'..msg.chat_id_) then
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
       chat_kick(msg.chat_id_, msg.sender_user_id_)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال ترانہ در گروه ممنوع نی باشد</code> ⚠️\n● - <code>توجہ حالت مسدودسازے فعال می باشد</code> ❌", 1, 'html')
          return 
   end
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال ترانہ در گروه ممنوع می باشد.حالت هشدار فعال می باشد</code> ⚠️❌", 1, 'html')
          return 
   end
   end
 ...
 if not is_mod(msg.sender_user_id_, msg.chat_id_) then
  if database:get('bot:voice:mute'..msg.chat_id_) then
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
       chat_kick(msg.chat_id_, msg.sender_user_id_)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال صدا در گروه ممنوع می باشد</code> ⚠️\n● - <code>توجہ حالت مسدود سازے فعال می باشد</code> ❌", 1, 'html')
          return 
   end
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال صدا درگروه ممنوع می باشد.حالت هشدار فعال می باشد</code> ⚠️❌", 1, 'html')
          return 
   end
   end
 ...
 if not is_mod(msg.sender_user_id_, msg.chat_id_) then
  if database:get('bot:location:mute'..msg.chat_id_) then
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
       chat_kick(msg.chat_id_, msg.sender_user_id_)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال مختصات جغرافیایی در گروه ممنوع می باشد</code> ⚠️\n● - <code>توجہ حالت مسدودسازے فعال می باشد</code> ❌", 1, 'html')
          return 
   end
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال مختصات جغرافیایی در گروه ممنوع میباشد.حالت هشدار فعال می باشد</code> ⚠️❌", 1, 'html')
          return 
   end
   end
 ...
 if not is_mod(msg.sender_user_id_, msg.chat_id_) then
  if database:get('bot:video:mute'..msg.chat_id_) then
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
       chat_kick(msg.chat_id_, msg.sender_user_id_)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال فایل (ویدیو) ممنوع می باشد</code> ⚠️\n● - <code>توجہ حالت مسدود سازے فعال می باشد</code> ❌", 1, 'html')
          return 
   end
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
          send(msg.chat_id_, 0, 1, "<code>ايدی : </code><i>"..msg.sender_user_id_.."</i>\n<code>ارسال (ویدیو) در گروه ممنوع می باشد.حالت هشدار فعال می باشد</code>", 1, 'html')
          return 
   end
   end
 ...
 if not is_mod(msg.sender_user_id_, msg.chat_id_) then
  if database:get('bot:gifs:mute'..msg.chat_id_) and not is_mod(msg.sender_user_id_, msg.chat_id_) then
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
       chat_kick(msg.chat_id_, msg.sender_user_id_)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال ( گیف ) در گروه ممنوع می باشد.</code> ⚠️\n● - <code>توجہ حالت مسدودسازے فعال می باشد</code> ❌", 1, 'html')
          return 
   end
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال( گیف ) درگروه ممنوع می باشد.حالت هشدار فعال می باشد</code> ⚠️❌", 1, 'html')
          return 
   end
   end
...
text:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") then
     ...
     local id = msg.id_
        ...
        delete_msg(chat,msgs)
chat_kick(msg.chat_id_, msg.sender_user_id_)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال ( لینک) در گروه ممنوع می باشد</code> ⚠️\n● - <code>توجہ حالت مسدودسازے فعال می باشد </code> ❌", 1, 'html')
  end
     ...
     local id = msg.id_
        ...
        local user_id = msg.sender_user_id_
        delete_msg(chat,msgs)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال ( لینک ) در گروه ممنوع می باشد.حالت هشدار فعال می باشد.</code> ⚠️❌", 1, 'html')
	end
 end
            ...
            if text then
              ...
              if database:get('bot:spam:warn'..msg.chat_id_) and string.len(text) > (sens) or ctrl_chars > (sens) or real_digits > (sens) then
                delete_msg(chat,msgs)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال ( اسپم ) در گروه ممنوع می باشد.حالت هشدار فعال می باشد</code> ⚠️❌", 1, 'html')
              end
          end 
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
       chat_kick(msg.chat_id_, msg.sender_user_id_)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال ( متن ) در گروه فعال می باشد.</code> ⚠️\n● - <code>توجہ حالت مسدودسازے فعال می باشد</code> ❌", 1, 'html')
          return 
   end
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال ( متن ) در گروه فعال می باشد.حالت هشدار فعال می باشد</code> ⚠️❌", 1, 'html')
          return 
   end
if msg.forward_info_ then
if database:get('bot:forward:mute'..msg.chat_id_) then
...
if database:get('bot:forward:ban'..msg.chat_id_) then
	if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
     local id = msg.id_
        ...
        delete_msg(chat,msgs)
		                chat_kick(msg.chat_id_, msg.sender_user_id_)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال ( نقل قول ) در گروه فعال می می باشد</code> ⚠️\n● - <code>توجہ حالت مسدودسازے فعال می باشد</code> ❌", 1, 'html')
	end
   end
...
if database:get('bot:forward:warn'..msg.chat_id_) then
	if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
     local id = msg.id_
        ...
        local user_id = msg.sender_user_id_
        delete_msg(chat,msgs)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code> ارسال ( نقل قول ) در گروه فعال می باشد.حالت هشدار فعال می باشد</code> ⚠️❌", 1, 'html')
	end
   end
end
elseif msg_type == 'MSG:Text' then
   ...
   if database:get('bot:tag:mute'..msg.chat_id_) then
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
       chat_kick(msg.chat_id_, msg.sender_user_id_)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال < @ > در گروه فعال می باشد</code> ⚠️\n● - <code>توجہ حالت مسدودسازے فعال می باشد</code> ❌", 1, 'html')
          return 
   end
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال < @ > در گروه فعال می باشد</code> ⚠️❌", 1, 'html')
          return 
   end
 end
   	if text:match("#") then
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال < # > در گروه فعال می باشد.حالت هشدار فعال می باشد </code> ⚠️❌", 1, 'html')
          return 
   end
end
     ...
     local id = msg.id_
        ...
        delete_msg(chat,msgs)
       chat_kick(msg.chat_id_, msg.sender_user_id_)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال < / > در گروه ممنوع می باشد</code> ⚠️\n● - <code>توجہ حالت مسدودسازے فعال می باشد</code> ❌", 1, 'html')
	end 
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
       chat_kick(msg.chat_id_, msg.sender_user_id_)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال ( صفحات اینترنتی ) در گروه فعال می باشد</code> ⚠️\n● - <code>توجہ حالت مسدودسازے فعال می باشد</code> ❌", 1, 'html')
          return 
   end
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال ( صفحات اینترنتی ) در گروه فعال می باشد.حالت هشدار فعال می باشد</code> ⚠️❌", 1, 'html')
          return 
   end
 end
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
       chat_kick(msg.chat_id_, msg.sender_user_id_)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال ( کلمات عربے ) در گروه فعال می باشد</code> ⚠️\n● - <code>توجہ حالت مسدودسازے فعال می باشد</code> ❌", 1, 'html')
          return 
   end
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال ( کلمات عربے ) در گروه فعال می باشد.حالت هشدار فعال می باشد</code> ⚠️❌", 1, 'html')
          return 
   end
 end
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
       chat_kick(msg.chat_id_, msg.sender_user_id_)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال ( کلمات انگلیسی ) در گروه فعال می باشد</code> ⚠️\n● - <code>توجہ حالت مسدودسازے فعال می باشد</code> ❌", 1, 'html')
          return 
   end
    ...
    local user_id = msg.sender_user_id_
       delete_msg(chat,msgs)
          send(msg.chat_id_, 0, 1, "● - <code>ایدی 📍 : </code><i>"..msg.sender_user_id_.."</i>\n● - <code>ارسال ( کلمات انگلیسی ) در گروه فعال می باشد.حالت هشدار فعال می باشد</code> ⚠️❌", 1, 'html')
          return 
   end
     end
    end
...
if text:match("^[Dd][Ee][Vv]$")or
text:match("^[Tt][Hh][Uu][Nn][Dd][Ee][r]$") or text:match("^صاحب ربات$") or text:match("^خرید سورس$") or text:match("^خرید$") or text:match("^ThunderTeam$") or text:match("^اشتراک$") or text:match("^رعد$") and msg.reply_to_message_id_ == 0 then
sendContact(msg.chat_id_, msg.id_, 0, 1, nil, 9036237472, "Sudo ThunderTeam" , "", bot_id)
end
...
if text == 'من اومدم' then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
moody = "خوش اومدے فداتشم💙"
else 
moody = ''
end
send(msg.chat_id_, msg.id_, 1, moody, 1, 'md')
...
if text == 'ربات' then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
moody = "حاجے آنلاینم اذیت نکن خودتا😂✋"
else 
moody = ''
end
send(msg.chat_id_, msg.id_, 1, moody, 1, 'md')
end
if text == 'پشتیبانی' then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
moody = "انجام شد!\n کاربرگرامے لطفا توجہ داشتہ باشید درصورت رعایت نکردن موارد زیر توسط ربات ما مسدودسازے ڪُلے خواهید شد.\n 1-رعایت ادب و احترام الزامی است \n 2-از دعوت بات هاے تبچے و ... خود دارے فرمایید \n 3- سوالات و مشکلات مربوط بہ ربات را در گروه مطرح کنید \n 4- از ارسال پیام هاے تکرارے و لینک دار خود دارے کنید \n 5- درخواست ها (پیشنهاد هاے) خود را فقط از مُدیران پشتیبانی بخواهید  \n 6- قوانین گروه را حتما مطالعہ کنید. \n بہ پشتیبانی خوش آمدید \n https://t.me/joinchat/GfMFnj7W660Q8L0g4RqIGA"
else 
moody = ''
end
send(msg.chat_id_, msg.id_, 1, moody, 1, 'md')
...
if text == 'اطلاعات ربات' then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
moody = "✶اطلاعات رُبات Thunder :\n❶ اطلاعات سورس\n✶[سورس بہ دو صورت\n (فارسی) و (انگلیسی)\nــــ ــــ ـــــ ـــــ\n(عربے) و (انگلیسی) میباشد]\n\n✶سورس بہ صورت تک پلاگ میباشد و هیچ گونه نسخه اے از این سورس اوپن نخواهد شد⚠️\n⚠️توجہ .....⚠️توجہ...ـ\nفریب کانال هاے اوپن سورس و تیم هاے  برنامہ نویسی را نخورید از این سورس هیچ نسخہ اے تاڪنون منتشر نشده است√\nاین سورس توسط تیم\n [ThunderTeam] \nنوشتہ شده بازسازے و باگ گیرے شده است واین سورس بہ زبان Lua می باشد\n❷ قابلیت ها\n✶-بہ جرعت میتوان این سورس را یکی از کاملترین سورسهاے موجود خواند.\n\n✶- قابلیت هشدار براے تمامے قفل ها\n✶- قابلیت ارسال پست براے تمامی کاربران با ثبت بازدید\n✶- قابلیت تنظیم مسدود سازے براے تمامے قفل ها\n✶- قابلیت نمایش تعداد گروه هاے دعوت شده توسط ادمین هاے ربات\n\n\n✶چنل مخصوص تیم:\n@ThunderTeam\n✶گپ پشتیبانی ربات:\n https://t.me/joinchat/GfMFnj7W660Q8L0g4RqIGA "
else 
moody = ''
end
send(msg.chat_id_, msg.id_, 1, moody, 1, 'md')
end
if text == 'بازار یابی' then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
moody = "شما میتوانید از طریق روش هاے زیر بازاریابی کنید\n 1- معرفے ربات و کارکرد آن بہ دیگران و خرید ربات توسط آنها(اضافه شدن یک گروه رایگان بہ پنل مُدیریتی ما توسط شما) \n 2-  اضافه کردن بالاے 300 ممبر بہ گروه پشتیبانی(اضافه شدن یک گروه رایگان بہ پنل مُدیریتی ما توسط شما بہ مدت 25 روز)\n 3- بازدید زدن 2k براے بنر ما (بہ مدت 25)"
else 
moody = ''
end
send(msg.chat_id_, msg.id_, 1, moody, 1, 'md')
...
if text == 'تعرفه' then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
moody = "درحال حاظر تعرفہ مشخص نشده است🚫ֆ"
else
moody = ''
end
send(msg.chat_id_, msg.id_, 1, moody, 1, 'md')
...
if text == 'افلاینی' then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
moody = "هہ منو آفلاینی؟ /:"
else 
moody = ''
end
send(msg.chat_id_, msg.id_, 1, moody, 1, 'md')
...
if text == 'معرفی کن' then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
moody = "T—h—u—n—d—e—r \n✯ ربات متعلق بہ تیم  [ ThunderTeam@ ] می باشد✓\n\n✯ ربات توانایی مدیریت گروه را دارد✓\n\n✯ ربات از سرعت و قدرت خاصی برخوردار است✓\n\n✯این ربات نسخہ 1.5 می باشد..تاکنون هیچ نسخه ای منتشر نشده است\nT—h—u—n—d—e—r"
else 
moody = ''
end
send(msg.chat_id_, msg.id_, 1, moody, 1, 'md')
...
if not database:get('bot:rep:mute'..msg.chat_id_) then
moody = "——————\n❱❱*"PONG"* *Thunder Is Online[Active]*\n❱❱_Please_join Channel:_\n❱❱@ThunderTeam \n——————"
else 
moody = ''
end
send(msg.chat_id_, msg.id_, 1, moody, 1, 'md')
...
if text == 'من عشق کی ام؟' then 
if not database:get('bot:rep:mute'..msg.chat_id_) then
moody = "من عاشقتم عچقم🐸❤️"
else 
moody = ''
end
send(msg.chat_id_, msg.id_, 1, moody, 1, 'md')
...
send(msg.chat_id_, msg.id_, 1, moody, 1, 'md')
	...
	if text:match("^خارج شو$") and is_admin(msg.sender_user_id_, msg.chat_id_) then
	     chat_leave(msg.chat_id_, bot_id)
    end
	-----------------------------------------------------------------------------------------------
        local text = msg.content_.text_:gsub('تنظیم مدیر','setmote')
	...
	if database:sismember(hash, result.sender_user_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, '● - *انجام شد!*\n کاربرمورد نظر *'..result.sender_user_id_..'* بہ مقام ادمین گروه ترفیع گرفته بود√☑️', 1, 'md')
              end
            else
         ...
         send(msg.chat_id_, msg.id_, 1, '● - *انجام شد!*\n کاربر مورد نظر *'..result.sender_user_id_..'* بہ مقام ادمین گروه ارتقا یافت☑️', 1, 'md')
              end
	end 
    end
	...
	if result.id_ then
            ...
            texts = '<code>User '..result.id_..' promoted as moderator.!</code>'
                        ...
                        texts = '● - <code>*انجام شد!* \n کاربر </code>'..result.id_..'<code> مدیر گروه می باشد√</code> ☑️'
            end
          else 
              if database:get('lang:gp:'..msg.chat_id_) then
            texts = '<code>User not found!</code>'
          else
                        texts = '<code>*خطایی رخ داد*\n *کاربر یافت نشد!*</code>⚠️'
end
    end
   ...
   send(msg.chat_id_, msg.id_, 1, '● - *انجام شد!*\n کاربر *'..apmd[2]..'* بہ مقام ادمین گروه انتخاب شد√ ☑️', 1, 'md')
          end
    end
	-----------------------------------------------------------------------------------------------
        local text = msg.content_.text_:gsub('گرفتن مقام ','remmote')
...
send(msg.chat_id_, msg.id_, 1, '● - *خطایی رخ داد!* \n کاربر *'..result.sender_user_id_..'* ادمین گروه نیست√ ⚠️', 1, 'md')
              end
	else
    ...
    send(msg.chat_id_, msg.id_, 1, '● - *انجام شد!* \n کاربر *'..result.sender_user_id_..'* باموفقیت برکنار شد√ ⚠️', 1, 'md')
	end
  end
  end
	...
	if result.id_ then
         database:srem(hash, result.id_)
            ...
            texts = '<b>User </b><code>'..result.id_..'</code> <b>Demoted</b>'
                        ...
                        texts = '● - <code>کاربر </code>'..result.id_..'<code> باموفقیت برکنار شد√</code> ⚠️'
    end
          else 
              if database:get('lang:gp:'..msg.chat_id_) then
            texts = '<code>User not found!</code>'
    ...
    send(msg.chat_id_, msg.id_, 1, '● - *انجام شد!* \n کاربر *'..apmd[2]..'* از مقام ادمین برکنار شد√ ⚠️', 1, 'md')
  end
    end
	-----------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, 1, '*خطایی رخ داد!*\n شما نمیتوانید مدیران گروه یا صاحبان ربات را [اخراج / مسدود] کنید⚠️❌', 1, 'md')
end
    else
    if database:sismember(hash, result.sender_user_id_) then
                  if database:get('lang:gp:'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_, 1, '*خطایی رخ داد*!\n کاربر *'..result.sender_user_id_..'* `از قبل مسدود شده بود` ⚠️', 1, 'md')
end
    ...
    send(msg.chat_id_, msg.id_, 1, '● - `*انجام شد!* \n کاربر` *'..result.sender_user_id_..'* `بہ لیست مسدود اضافه شد` ⚠️', 1, 'md')
end
		 chat_kick(result.chat_id_, result.sender_user_id_)
	end
    end
...
send(msg.chat_id_, msg.id_, 1, '*خطایی رخ داد*! \n شما نمیتوانیدمدیران گروه یا صاحبان ربات را [اخراج/مسدود] کنید ⚠️❌', 1, 'md')
end
    else
            ...
            texts = '<b>User </b><code>'..result.id_..'</code> <b>Banned.!</b>'
                        ...
                        texts = '● - <code>*انجام شد!* \n کاربر</code>'..result.id_..'<code> بہ لیست مسدود اضافه شد</code> ⚠️'
end
		 chat_kick(msg.chat_id_, result.id_)
	end
          else 
...
send(msg.chat_id_, msg.id_, 1, '*خطایی رخ داد!* \n شما نمیتوانید مدیران گروه یا صاحبان ربات [مسدود/اخراج] کنید ⚠️❌', 1, 'md')
end
    else
    ...
    send(msg.chat_id_, msg.id_, 1, '*انجام شد!* \n کاربر *'..apba[2]..'* `بہ لیست مسدود اضافه شد√` ⚠️', 1, 'md')
  	end
	end
end
  ----------------------------------------------unban--------------------------------------------
          local text = msg.content_.text_:gsub('لغو مسدودیت','unban')
...
send(msg.chat_id_, msg.id_, 1, '● - `انجام شد\n کاربر` *'..result.sender_user_id_..'* `درلیست مسدودیت نمیباشد☑️', 1, 'md')
end
	else
         database:srem(hash, result.sender_user_id_)
                  if database:get('lang:gp:'..msg.chat_id_) then
   ...
   send(msg.chat_id_, msg.id_, 1, '● - `انجام شد\n کاربر` *'..result.sender_user_id_..'* از لیست مسدودیت #باموفقیت خارج شد ☑️', 1, 'md')
end
	end
    end
	...
	if result.id_ then
         database:srem('bot:banned:'..msg.chat_id_, result.id_)
            ...
            texts = '<b>User </b><code>'..result.id_..'</code> <b>Unbanned.!</b>'
                        ...
                        texts = '● - <code>انجام شد!\n کاربر</code>'..result.id_..'<code>از لیست مسدودیت #باموفقیت خارج شد</code> ☑️'
end
          else 
                  if database:get('lang:gp:'..msg.chat_id_) then
            texts = '<code>User not found!</code>'
   ...
   send(msg.chat_id_, msg.id_, 1, '● - `انجام شد!\n کاربر` *'..apba[2]..'* `کاربر از لیست مسدودیت #باموفقیت خارج شد` ☑️', 1, 'md')
end
  end
	-----------------------------------------------------------------------------------------------
          local text = msg.content_.text_:gsub('حذف','delall')
	...
	if is_mod(ass[2], msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'خطایی رخ داد! \n بہ دلیل نبودن ادمین گروه انجام نشد⚠️❌', 1, 'md')
end
else
         ...
         send(msg.chat_id_, msg.id_, 1, '● - `انجام شد!\n تعداد` [*'..ass[2]..'* ]`چت از چت هاے گروه پاک شد` ⚠️', 1, 'md')
end    end
	end
 -----------------------------------------------------------------------------------------------
	...
	if is_mod(result.id_, msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'خطایی رخ داد! \n بہ دلیل نبودن ادمین در گروه انجام نشد! ⚠️❌', 1, 'md')
end
return false
    end
            ...
            texts = '<b>All Msg From user</b> <code>'..result.id_..'</code> <b>Deleted!</b>'
                        ...
                        texts = '● - <code>انجام شد! \n </code>'..result.id_..'<code>تمام چت هاے کاربر پاک شد!</code> ⚠️'
end
          else 
                  if database:get('lang:gp:'..msg.chat_id_) then
            texts = '<code>User not found!</code>'
  ...
  -----------------------------------------banall--------------------------------------------------
          local text = msg.content_.text_:gsub('مسدود همگانی','banall')
...
send(msg.chat_id_, msg.id_, 1, 'خطایی رخ داد! \n کاربر گرامے شما نمیتوانید ادمین  یا مدیران ربات را مسدود همگانے کنید ⚠️❌', 1, 'md')
end
    else
              database:sadd(hash, result.sender_user_id_)
              chat_kick(result.chat_id_, result.sender_user_id_)
              if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  texts = '● - <code>انجام شد!\n کاربر </code>'..result.sender_user_id_..'<code>مسدود همگانے شد!</code> ⚠️'
end
end
	         send(msg.chat_id_, msg.id_, 1, texts, 1, 'html')
            end
         ...
         send(msg.chat_id_, msg.id_, 1, '*You Can,t [Banall] admins/sudo!!*', 1, 'md')
            ...
            send(msg.chat_id_, msg.id_, 1, 'خطایی رخ داد! \n کاربر گرامے شما نمیتوانید ادمین یا مدیران ربات را مسدود همگانی کنید ⚠️❌', 1, 'md')
end
  else
              local hash = 'bot:gbanned:'
                if database:get('lang:gp:'..msg.chat_id_) then
                ...
                texts = '● - <code>انجام شد! \n </code>'..result.id_..'<code>مسدود همگانے شد</code> ⚠️'
end
  ...
  local hash = 'bot:gbanned:'
	if is_admin(apbll[2], msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, '*You Can,t [Banall] admins/sudo!!*', 1, 'md')
            ...
            send(msg.chat_id_, msg.id_, 1, 'خطایی رخ داد! \n کاربرگرامی شما نمیتوانید ادمین یا مدیران ربات را مسدود همگانے کنید! ⚠️❌', 1, 'md')
end
    else
    ...
    send(msg.chat_id_, msg.id_, 1, '● - `انجام شد! \nکاربر` *'..apbll[2]..'* `مسدودیت همگانے شد` ⚠️', 1, 'md')
  	end
	end
end
          -----------------------------------------------------------------------------------------------
          local text = msg.content_.text_:gsub('لغو مسدودیت همگانی','unbanall')
          if text:match("^[Uu][Nn][Bb][Aa][Nn][Aa][Ll][Ll]$") and is_sudo(msg) and msg.reply_to_message_id_ then
            function ungban_by_reply(extra, result, success)
              ...
              if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  texts =  '● - <code>انجام شد! \n کاربر '..result.sender_user_id_..' از لیست مسدودیت همگانے #خارج شد! </code> ☑️'
	         send(msg.chat_id_, msg.id_, 1, texts, 1, 'html')
            end
              database:srem(hash, result.sender_user_id_)
            end
          ...
          if text:match("^[Uu][Nn][Bb][Aa][Nn][Aa][Ll][Ll] @(.*)$") and is_sudo(msg) then
            ...
            function ungban_by_username(extra, result, success)
              ...
              if result.id_ then
                ...
                texts = '● - <code>انجام شد! \n کاربر</code>'..result.id_..'<code>از لیست مسدودیت همگانے #خارج شد!</code> ☑️'
                end
                database:srem(hash, result.id_)
              else
                if database:get('lang:gp:'..msg.chat_id_) then
          ...
          if text:match("^[Uu][Nn][Bb][Aa][Nn][Aa][Ll][Ll] (%d+)$") and is_sudo(msg) then
            ...
            local hash = 'bot:gbanned:'
              ...
              texts = '<b>User :</b> '..apbll[2]..' <b>Has been Globally Unbanned !</b>'
                ...
                texts = '● - <code>انجام شد! \n کاربر</code>'..apbll[2]..'<code>از لیست مسدودیت همگانے #خارج شد!</code> ☑️'
end
              send(msg.chat_id_, msg.id_, 1, texts, 1, 'html')
            end
	-----------------------------------------------------------------------------------------------
          local text = msg.content_.text_:gsub('خفه','silent')
...
send(msg.chat_id_, msg.id_, 1, 'خطایی رخ داد!\n شما نمیتوانید ادمین ها یا مدیران ربات را خفہ یا اخراج کنید` ⚠️❌', 1, 'md')
end
    else
    if database:sismember(hash, result.sender_user_id_) then
                  if database:get('lang:gp:'..msg.chat_id_) then
   ...
   send(msg.chat_id_, msg.id_, 1, '● - `انجام شد!\n کاربر ` *'..result.sender_user_id_..'* `از قبل خفہ شده بود!` ⚠️', 1, 'md')
end
	else
         database:sadd(hash, result.sender_user_id_)
                  if database:get('lang:gp:'..msg.chat_id_) then
    ...
    send(msg.chat_id_, msg.id_, 1, 'انجام شد! \n کاربر` *'..result.sender_user_id_..'* `خفہ شد!` ⚠️', 1, 'md')
end
	end
    end
	end
...
send(msg.chat_id_, msg.id_, 1, 'خطایی رخ داد! \n شما نمیتوانید ادمین یا مدیران ربات را خفہ یا اخراج کنید` ⚠️❌', 1, 'md')
end
    else
            ...
            texts = '<b>User </b><code>'..result.id_..'</code> <b>silent</b>'
                        ...
                        texts = '● - <code>انجام شد!\n کاربر </code>'..result.id_..'<code> خفہ شد</code> ⚠️'
end
		 chat_kick(msg.chat_id_, result.id_)
	end
          else 
...
send(msg.chat_id_, msg.id_, 1, 'خطایی رخ داد!\n شما نمیتوانید ادمین یا مدیران ربات را خفہ کنید ⚠️❌', 1, 'md')
end
    else
    ...
    send(msg.chat_id_, msg.id_, 1, '● - `انجام شد! \n کاربر` *'..apsi[2]..'* `خفہ شد` ⚠️', 1, 'md')
end
	end
    end 
	-----------------------------------------------------------------------------------------------
          local text = msg.content_.text_:gsub('لغو خفه','unsilent')
...
send(msg.chat_id_, msg.id_, 1, '● - `انجام شد! \n کاربر` *'..result.sender_user_id_..'* `درلیست خفہ ها نمے باشد` ☑️', 1, 'md')
end
	else
         database:srem(hash, result.sender_user_id_)
                  if database:get('lang:gp:'..msg.chat_id_) then
   ...
   send(msg.chat_id_, msg.id_, 1, '● - `انجام شد! \n کاربر ` *'..result.sender_user_id_..'* `از لیست خفہ ها #اخراج شد` ☑️', 1, 'md')
end
	end
    end
	...
	if result.id_ then
         database:srem('bot:muted:'..msg.chat_id_, result.id_)
            ...
            texts = '<b>User </b><code>'..result.id_..'</code> <b>unsilent.!</b>'
                        ...
                        texts = '● - <code>انجام شد! \n کاربر </code>'..result.id_..'<code>از لیست خف ها #خارج شد</code> ☑️'
end
          else 
                  if database:get('lang:gp:'..msg.chat_id_) then
            texts = '<code>User not found!</code>'
   ...
   send(msg.chat_id_, msg.id_, 1, '● - `انجام شد!\n کاربر ` *'..apsi[2]..'* `از لیست خفہ #خارج شد` ☑️', 1, 'md')
end
  end
    -----------------------------------------------------------------------------------------------
  ...
  if text:match("^[Kk][Ii][Cc][Kk]$") and msg.reply_to_message_id_ and is_mod(msg.sender_user_id_, msg.chat_id_) then
	...
	if is_mod(result.sender_user_id_, result.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, '● - `خطایی رخ داد!\n شما نمی توانید ادمین یا مدیران ربات را اخراج کنید` ⚠️❌', 1, 'md')
end
  else
                if database:get('lang:gp:'..msg.chat_id_) then
        send(msg.chat_id_, msg.id_, 1, '*User* _'..result.sender_user_id_..'_ *Kicked.*', 1, 'md')
      else 
        send(msg.chat_id_, msg.id_, 1, '● - `انجام شد!\n کاربر` '..result.sender_user_id_..' `#باموفقیت اخراج شد` ⚠️', 1, 'md')
end
        chat_kick(result.chat_id_, result.sender_user_id_)
        end
	end
...
send(msg.chat_id_, msg.id_, 1, '● - خطایی رخ داد!\n شما نمیتوانید ادمین یا مدیران ربات را اخراج کنید ⚠️❌', 1, 'md')
end
    else
                  if database:get('lang:gp:'..msg.chat_id_) then
            texts = '<b>User </b><code>'..result.id_..'</code> <b>Kicked.!</b>'
else
                        texts = '● - <code>انجام شد!\n کاربر</code>'..result.id_..'<code> #باموفقیت اخراج شد</code> ⚠️'
end
		 chat_kick(msg.chat_id_, result.id_)
	end
          else 
...
send(msg.chat_id_, msg.id_, 1, '● - خطایی رخ داد! \n شما نمیتوانید ادمین یا مدیران ربات را اخراج کنید ⚠️❌', 1, 'md')
    ...
    send(msg.chat_id_, msg.id_, 1, '● - `انجام شد! \n کاربر` *'..apki[2]..'* `#باموفقیت اخراج شد` ⚠️', 1, 'md')
  	end
	end
end
          -----------------------------------------------------------------------------------------------
 local text = msg.content_.text_:gsub('دعوت','invite')
   ...
   function inv_reply(extra, result, success)
    add_user(result.chat_id_, result.sender_user_id_, 5)
        ...
        send(msg.chat_id_, msg.id_, 1, '● - `انجام شد! \n کاربر` '..result.sender_user_id_..' `بہ گروه #باموفقیت بہ گروه دعوت شد` ☑️', 1, 'md')
   end
   end
   ...
   if text:match("^[Ii][Nn][Vv][Ii][Tt][Ee] @(.*)$") and is_sudo(msg) then
    ...
    function invite_by_username(extra, result, success)
     if result.id_ then
            ...
            texts = '● - <code>انجام شد! \n کاربر</code>'..result.id_..'<code> #باموفقیت بہ گروه دعوت شد</code> ☑️'
end
    ...
    send(msg.chat_id_, msg.id_, 1, '● - `انجام شد! \n کاربر` *'..apee[2]..'* `#باموفقیت بہ گروه دعوت شد` ☑️', 1, 'md')
  	end
    end
	-----------------------------------------------------------------------------------------------
          local text = msg.content_.text_:gsub('تنظیم صاحب','setowner')
...
send(msg.chat_id_, msg.id_, 1, '● - `انجام شد!\n کاربر` *'..result.sender_user_id_..'* `بہ عنوان صاحب گروه از قبل انتخاب شده بود` ☑️', 1, 'md')
end
	else
         database:sadd(hash, result.sender_user_id_)
                  if database:get('lang:gp:'..msg.chat_id_) then
   ...
   send(msg.chat_id_, msg.id_, 1, '● - `انجام شد! \n کاربر` *'..result.sender_user_id_..'* `بہ مقام صاحب گروه انتخاب شد` ☑️', 1, 'md')
end
	end
    end
	...
	if result.id_ then
            ...
            texts = '<b>User </b><code>'..result.id_..'</code> <b>Promoted as Group Owner.!</b>'
                        ...
                        texts = '● - <code>انجام شد!\n  کاربر</code>'..result.id_..'<code> بہ عنوان صاحب گروه انتخاب شد</code> ☑️'
end
          else 
                  if database:get('lang:gp:'..msg.chat_id_) then
            texts = '<code>User not found!</code>'
   ...
   send(msg.chat_id_, msg.id_, 1, '● - `انجام شد!\n کاربر` *'..apow[2]..'* `بہ عنوان صاحب گروه انتخاب شد` ☑️', 1, 'md')
end
    end
	-----------------------------------------------------------------------------------------------
          local text = msg.content_.text_:gsub('تنزل مقام','remowner')
...
send(msg.chat_id_, msg.id_, 1, '● - `انجام شد! \n کاربر` *'..result.sender_user_id_..'* `تنزل مقام یافت` ⚠️', 1, 'md')
end
	else
         database:srem(hash, result.sender_user_id_)
                  if database:get('lang:gp:'..msg.chat_id_) then
    ...
    send(msg.chat_id_, msg.id_, 1, '● - `انجام شد! \n کاربر ` *'..result.sender_user_id_..'* `از لیست مدیران حذف گردید` ⚠️', 1, 'md')
end
	end
    end
	...
	if result.id_ then
	     ...
	     if database:get('lang:gp:'..msg.chat_id_) then
            texts = '<b>User </b><code>'..result.id_..'</code> <b>Removed from ownerlist</b>'
                        ...
                        texts = '● - <code>انجام شد! \n کاربر </code>'..result.id_..'<code>از لیست صاحبان گروه حذف شد</code> ⚠️'
end
          else 
	     if database:get('lang:gp:'..msg.chat_id_) then
            texts = '<code>User not found!</code>'
    ...
    send(msg.chat_id_, msg.id_, 1, '● - `انجام شد! \n کاربر` *'..apow[2]..'* `از لیست صاحبان گروه حذف شد` ⚠️', 1, 'md')
end
    end
	-----------------------------------------------------------------------------------------------
	          local text = msg.content_.text_:gsub('تنظیم معاون ربات','setadmin')
	...
	if database:sismember(hash, result.sender_user_id_) then
  	...
  	send(msg.chat_id_, msg.id_, 1, '● - `انجام شد!\n کاربر` *'..result.sender_user_id_..'* `از  قبل معاون ربات بود` ☑️', 1, 'md')
end
	else
         database:sadd(hash, result.sender_user_id_)
	     if database:get('lang:gp:'..msg.chat_id_) then
  	...
  	send(msg.chat_id_, msg.id_, 1, '● - `انجام شد!  \n کاربر ` *'..result.sender_user_id_..'* `بہ لیست معاونان ربات #باموفقیت اضافہ شد` ☑️', 1, 'md')
end
	end
    end
	...
	if result.id_ then
            ...
            texts = '<b>User </b><code>'..result.id_..'</code> <b>Added to admins.!</b>'
                        ...
                        texts = '● - <code>انجام شد! \n کاربر </code>'..result.id_..'<code>بہ لیست معاونان ربات #باموفقیت اضافہ شد</code> ☑️'
end
          else 
	     if database:get('lang:gp:'..msg.chat_id_) then
            texts = '<code>User not found!</code>'
	...
	send(msg.chat_id_, msg.id_, 1, '_User_ *'..ap[2]..'* _Added to admins._', 1, 'md')
  	...
  	send(msg.chat_id_, msg.id_, 1, '● - `انجام شد!\n کاربر ` *'..ap[2]..'* `بہ لیست معاونان ربات #باموفقیت اضافہ شد` ☑️', 1, 'md')
end
    end
	-----------------------------------------------------------------------------------------------
          local text = msg.content_.text_:gsub('حذف معاون ربات','remadmin')
	...
	if not database:sismember(hash, result.sender_user_id_) then
  	...
  	send(msg.chat_id_, msg.id_, 1, '● - `انجام شد!\n کاربر` *'..result.sender_user_id_..'* `در حال حاظر معاون ربات نیست` ⚠️', 1, 'md')
end
	else
         database:srem(hash, result.sender_user_id_)
		     if database:get('lang:gp:'..msg.chat_id_) then
  	...
  	send(msg.chat_id_, msg.id_, 1, '● - `انجام شد!\n کاربر ` *'..result.sender_user_id_..'* `از لیست معاونان ربات #باموفقیت حذف شد` ⚠️', 1, 'md')
	...
	if result.id_ then
         database:srem(hash, result.id_)
            ...
            texts = '<b>User </b><code>'..result.id_..'</code> <b>Removed from Admins!</b>'
                        ...
                        texts = '● - <code>انجام شد! \n کاربر </code>'..result.id_..'<code>از لیست معاونان ربات #باموفقیت حذف شد</code> ⚠️'
end
          else 
		     if database:get('lang:gp:'..msg.chat_id_) then
            texts = '<code>User not found!</code>'
	...
	send(msg.chat_id_, msg.id_, 1, '_User_ *'..ap[2]..'* Removed from Admins!_', 1, 'md')
  	...
  	send(msg.chat_id_, msg.id_, 1, '● - `انجام شد!\n کاربر` *'..ap[2]..'* `از لیست معاونان ربات حذف شد` ⚠️', 1, 'md')
end
    end 
	-----------------------------------------------------------------------------------------------
	if text:match("^[Mm][Oo][Dd][Ll][Ii][Ss][Tt]$") and is_mod(msg.sender_user_id_, msg.chat_id_) or text:match("^لیست مدیران$") and is_mod(msg.sender_user_id_, msg.chat_id_) then
    local hash =  'bot:mods:'..msg.chat_id_
	local list = database:smembers(hash)
  if database:get('lang:gp:'..msg.chat_id_) then
  text = "<b>Mod List:</b>\n\n"
else 
  text = "● - <code>لیست مدیران</code>⬇️ :\n\n"
  end
	...
	if #list == 0 then
	   if database:get('lang:gp:'..msg.chat_id_) then
                ...
                text = "● - <code>متاسفیم! لیست مدیران خالے می باشد!</code> ⚠️"
end
    end
	send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
  end

	if text:match("^[Bb][Aa][Dd][Ll][Ii][Ss][Tt]$") and is_mod(msg.sender_user_id_, msg.chat_id_) or text:match("^لیست فیلترها$") and is_mod(msg.sender_user_id_, msg.chat_id_) then
	local hash = 'bot:filters:'..msg.chat_id_
      if hash then
         local names = database:hkeys(hash)
  if database:get('lang:gp:'..msg.chat_id_) then
  ...
  text = "● - <code>لیست کلمات فیلتر شده</code>⬇️ :\n\n"
	...
	if #names == 0 then
	   if database:get('lang:gp:'..msg.chat_id_) then
                ...
                text = "● - <code>لیست کلمات فیلتر شده خالے می باشد!</code> ⚠️"
end
    end
		  send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
       end 
	...
	-----------------------------------------------------------------------------------------------
	if text:match("^[Ss][Ii][Ll][Ee][Nn][Tt][Ll][Ii][Ss][Tt]$") and is_mod(msg.sender_user_id_, msg.chat_id_) or text:match("^لیست خفه ها$") and is_mod(msg.sender_user_id_, msg.chat_id_) then
    local hash =  'bot:muted:'..msg.chat_id_
	local list = database:smembers(hash)
  if database:get('lang:gp:'..msg.chat_id_) then
  text = "<b>Silent List:</b>\n\n"
else 
  text = "● - <code>لیست خفہ شده ها</code>⬇️ :\n\n"
end	
for k,v in pairs(list) do
	local user_info = database:hgetall('user:'..v)
		if user_info and user_info.username then
	...
	if #list == 0 then
	   if database:get('lang:gp:'..msg.chat_id_) then
                ...
                text = "● - <code>لیست خفہ شده ها خالی می باشد</code> ⚠️"
end
end
	send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
    end
	-----------------------------------------------------------------------------------------------
	if text:match("^[Oo][Ww][Nn][Ee][Rr][Ss]$") and is_sudo(msg) or text:match("^[Oo][Ww][Nn][Ee][Rr][Ll][Ii][Ss][Tt]$") and is_sudo(msg) or text:match("^لیست صاحبان$") and is_sudo(msg) then
    local hash =  'bot:owners:'..msg.chat_id_
	local list = database:smembers(hash)
  if database:get('lang:gp:'..msg.chat_id_) then
  text = "<b>owner List:</b>\n\n"
else 
  text = "● - <code>لیست صاحبان گروه</code>⬇️ :\n\n"
end	
for k,v in pairs(list) do
	local user_info = database:hgetall('user:'..v)
		if user_info and user_info.username then
	...
	if #list == 0 then
	   if database:get('lang:gp:'..msg.chat_id_) then
                ...
                text = "● - <code>لیست صاحبان گروه خالے می باشد!</code> ⚠️"
end
end
	send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
    end
	-----------------------------------------------------------------------------------------------
	if text:match("^[Bb][Aa][Nn][Ll][Ii][Ss][Tt]$") and is_mod(msg.sender_user_id_, msg.chat_id_) or text:match("^لیست مسدودی ها$") and is_mod(msg.sender_user_id_, msg.chat_id_) then
    local hash =  'bot:banned:'..msg.chat_id_
	local list = database:smembers(hash)
  if database:get('lang:gp:'..msg.chat_id_) then
  text = "<b>ban List:</b>\n\n"
else 
  text = "● - <code>لیست مسدودے ها</code>⬇️ :\n\n"
end	
for k,v in pairs(list) do
	local user_info = database:hgetall('user:'..v)
		if user_info and user_info.username then
	...
	if #list == 0 then
	   if database:get('lang:gp:'..msg.chat_id_) then
                ...
                text = "● - <code>لیست مسدودے ها خالے می باشد!</code> ⚠️"
end
end
	send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
end
...
for k,v in pairs(list) do
	...
	-----------------------------------------------------------------------------------------------
	if text:match("^[Aa][Dd][Mm][Ii][Nn][Ll][Ii][Ss][Tt]$") and is_sudo(msg) or text:match("^لیست معاونان ربات$") and is_sudo(msg) then
    local hash =  'bot:admins:'
	local list = database:smembers(hash)
  if database:get('lang:gp:'..msg.chat_id_) then
  text = "<b>Admin List:</b>\n\n"
else 
  text = "● - <code>لیست معاونین ربات</code>⬇️ :\n\n"
end	
for k,v in pairs(list) do
	local user_info = database:hgetall('user:'..v)
		if user_info and user_info.username then
	...
	if #list == 0 then
	   if database:get('lang:gp:'..msg.chat_id_) then
                ...
                text = "● - <code>لیست معاونان خالے می باشد!</code> ⚠️"
end
end
	send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
    end
	-----------------------------------------------------------------------------------------------
    if text:match("^[Ii][Dd]$") or text:match("^آیدی$") or text:match("^ایدی$") or text:match("^[Mm][Ee]$") or text:match("^من$") and msg.reply_to_message_id_ ~= 0 then
  ...
  -----------------------------------------------------------------------------------------------
          local text = msg.content_.text_:gsub('ايدی','من','id','Me','me')
...
--vardump(result)
   ...
   if result.photos_[0] then
      ...
      send(msg.chat_id_, msg.id_, 1, "You Have'nt Profile Photo!!", 1, 'md')
            ...
            send(msg.chat_id_, msg.id_, 1, "● - شما عکس پروفایلے ندارید!` ⚠️", 1, 'md')
end
   end
   ...
   if result.photos_[1] then
      ...
      send(msg.chat_id_, msg.id_, 1, "You Have'nt 2 Profile Photo!!", 1, 'md')
            ...
            send(msg.chat_id_, msg.id_, 1, "● - `شما 2 عکس پروفایل ندارید!` ⚠️", 1, 'md')
end
   end
   ...
   if result.photos_[2] then
      ...
      send(msg.chat_id_, msg.id_, 1, "You Have'nt 3 Profile Photo!!", 1, 'md')
            ...
            send(msg.chat_id_, msg.id_, 1, "● - `شما 3 عکس پروفایل ندارید!` ⚠️", 1, 'md')
end
   end
   elseif pronumb[2] == '4' then
      ...
      send(msg.chat_id_, msg.id_, 1, "You Have'nt 4 Profile Photo!!", 1, 'md')
            ...
            send(msg.chat_id_, msg.id_, 1, "● - شما 4 عکس پروفایل ندارید!` ⚠️", 1, 'md')
end
   end
   ...
   if result.photos_[4] then
      ...
      send(msg.chat_id_, msg.id_, 1, "You Have'nt 5 Profile Photo!!", 1, 'md')
            ...
            send(msg.chat_id_, msg.id_, 1, "● - `شما 5 عکس پروفایل ندارید!` ⚠️", 1, 'md')
end
   end
   ...
   if result.photos_[5] then
      ...
      send(msg.chat_id_, msg.id_, 1, "You Have'nt 6 Profile Photo!!", 1, 'md')
            ...
            send(msg.chat_id_, msg.id_, 1, "● - `شما 6 عکس پروفایل ندارید!` ⚠️", 1, 'md')
end
   end
   ...
   if result.photos_[6] then
      ...
      send(msg.chat_id_, msg.id_, 1, "You Have'nt 7 Profile Photo!!", 1, 'md')
            ...
            send(msg.chat_id_, msg.id_, 1, "● - `شما 7 عکس پروفایل ندارید!` ⚠️", 1, 'md')
end
   end
   ...
   if result.photos_[7] then
      ...
      send(msg.chat_id_, msg.id_, 1, "You Have'nt 8 Profile Photo!!", 1, 'md')
            ...
            send(msg.chat_id_, msg.id_, 1, "● - `شما 8 عکس پروفایل ندارید!` ⚠️", 1, 'md')
end
   end
   ...
   if result.photos_[8] then
      ...
      send(msg.chat_id_, msg.id_, 1, "You Have'nt 9 Profile Photo!!", 1, 'md')
            ...
            send(msg.chat_id_, msg.id_, 1, "● - `شما 9 عکس پروفایل ندارید!` ⚠️", 1, 'md')
end
   end
   ...
   if result.photos_[9] then
      ...
      send(msg.chat_id_, msg.id_, 1, "_You Have'nt 10 Profile Photo!!_", 1, 'md')
            ...
            send(msg.chat_id_, msg.id_, 1, "● - `شما 10 عکس پروفایل ندارید!` ⚠️", 1, 'md')
end
   end
 else
                if database:get('lang:gp:'..msg.chat_id_) then
      send(msg.chat_id_, msg.id_, 1, "*I just can get last 10 profile photos!:(*", 1, 'md')
            ...
            send(msg.chat_id_, msg.id_, 1, "● - `من فقط میتوانم تا 10 عکس پروفایل شما را ارسال کنم!` ⚠️", 1, 'md')
end
   end
   end
   tdcli_function ({
	...
	-----------------------------------------------------------------------------------------------
          local text = msg.content_.text_:gsub('حساسیت مسدودیت','flood ban')
	...
	if tonumber(floodmax[2]) < 2 then
         ...
         send(msg.chat_id_, msg.id_, 1, '*Wrong number*,_range is  [2-99999]_', 1, 'md')
           ...
           send(msg.chat_id_, msg.id_, 1, 'لطفا حساسیت را از *[2]* تا *[99999]* انتخاب کنید√⚠️', 1, 'md')
end
	else
...
send(msg.chat_id_, msg.id_, 1, '🌟انجام شد!\n حساسیت انتخاب شده [*'..floodmax[2]..'*] #باموفقیت ثبت شد√', 1, 'md')
end
	end
end

          local text = msg.content_.text_:gsub('حساسیت بیصدا','flood mute')
	...
	if tonumber(floodmax[2]) < 2 then
         ...
         send(msg.chat_id_, msg.id_, 1, '*Wrong number*,_range is  [2-99999]_', 1, 'md')
           ...
           send(msg.chat_id_, msg.id_, 1, 'لطفا حساسیت را از *[2]* تا *[99999]* تنظیم کنید√ ⚠️', 1, 'md')
end
	else
...
send(msg.chat_id_, msg.id_, 1, '● - `حساسیت هشدار #باموفقیت تنظیم شد بہ` ✓⬅️ : *'..floodmax[2]..'*', 1, 'md')
end
	end
end
          local text = msg.content_.text_:gsub('حساسیت پاک کردن','flood del')
...
send(msg.chat_id_, msg.id_, 1, '● - `حساسیت پاک کردن #باموفقیت تنظیم شد بہ` ✓⬅️ : *'..floodmax[2]..'*', 1, 'md')
end
	end
end
          local text = msg.content_.text_:gsub('حساسیت رگبار حذف','spam del')
...
send(msg.chat_id_, msg.id_, 1, '*Wrong number*,_range is  [40-99999]_', 1, 'md')
           ...
           send(msg.chat_id_, msg.id_, 1, 'لطفا حساسیت را از *[40]* تا *[99999]* تنظیم کنید√ ` ⚠️', 1, 'md')
end
 else
...
send(msg.chat_id_, msg.id_, 1, '● - `حساسیت رگبار حذف #باموفقیت تنظیم شد بہ` ✓⬅️ : *'..sensspam[2]..'*', 1, 'md')
end
end
end
          local text = msg.content_.text_:gsub('حساسیت رگبار هشدار','spam warn')
...
send(msg.chat_id_, msg.id_, 1, '● - `حساسیت رگبار هشدار #باموفقیت تنظیم شد بہ` ✓⬅️ : *'..sensspam[2]..'*', 1, 'md')
end
end
end

	-----------------------------------------------------------------------------------------------
          local text = msg.content_.text_:gsub('حساسیت ساعت','flood time')
	...
	if tonumber(floodt[2]) < 1 then
         ...
         send(msg.chat_id_, msg.id_, 1, '*Wrong number*,_range is  [2-99999]_', 1, 'md')
           ...
           send(msg.chat_id_, msg.id_, 1, 'لطفا حساسیت را از *[1]* تا *[99999]* تنظیم کنید√  ⚠️', 1, 'md')
end
	else
    database:set('flood:time:'..msg.chat_id_,floodt[2])
         ...
         send(msg.chat_id_, msg.id_, 1, '● - `حساسیت ساعت #باموفقیت تنظیم شد بہ ` ✓⬅️ : *'..floodt[2]..'*', 1, 'md')
end
	end
	end
	-----------------------------------------------------------------------------------------------
	...
	local link = database:get("bot:group:link"..msg.chat_id_)
	  if link then
         ...
         send(msg.chat_id_, msg.id_, 1, '<b>Group link:</b>\n'..link, 1, 'html')
                  ...
                  send(msg.chat_id_, msg.id_, 1, '● - <code>لینک گروه شما ⬇️ :</code>\n'..link, 1, 'html')
end
	  else
                if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '*There is not link set yet. Please add one by #setlink .*', 1, 'md')
       else 
                  send(msg.chat_id_, msg.id_, 1, '● -خطایی رخ داد! \n شما لینک گروه را ثبت نکرده اید! ⚠️', 1, 'md')
end
	  end
 	end
	...
	if text:match("^خوشامدگویی روشن$") and is_mod(msg.sender_user_id_, msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '● - `انجام شد!\n خوش آمدگویی #باموفقیت فعال شد! ` ✔️', 1, 'md')
		 database:set("bot:welcome"..msg.chat_id_,true)
	end
	if text:match("^خوشامدگویی خاموش$") and is_mod(msg.sender_user_id_, msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '● - `خوش آمدگویی #باموفقیت غیرفعال شد! ` ⚠️', 1, 'md')
		 database:del("bot:welcome"..msg.chat_id_)
	end
	...
	if text:match("^تنظیم خوشامدگویی (.*)$") and is_mod(msg.sender_user_id_, msg.chat_id_) then
	local welcome = {string.match(text, "^(تنظیم خوشامدگویی) (.*)$")} 
         send(msg.chat_id_, msg.id_, 1, '● - `متن خوش آمدگویی #ثبت شده عبارت است از` ✓⬇️ :\n\n`'..welcome[2]..'`', 1, 'md')
		 database:set('welcome:'..msg.chat_id_,welcome[2])
	end

          local text = msg.content_.text_:gsub('حذف خوشامدگویی','del wlc')
	if text:match("^[Dd][Ee][Ll] [Ww][Ll][Cc]$") and is_mod(msg.sender_user_id_, msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, '*Welcome Msg Has Been Deleted!*', 1, 'md')
                  ...
                  send(msg.chat_id_, msg.id_, 1, '● - `متن خوش آمدگویی #باموفقیت حذف شد` ⚠️❌', 1, 'md')
end
		 database:del('welcome:'..msg.chat_id_)
	end
	
          local text = msg.content_.text_:gsub('خوشامدگویی','get wlc')
	...
	if wel then
         send(msg.chat_id_, msg.id_, 1, '● - `متن ثبت شده خوش آمدگویی گروه` ⬇️ :'..wel, 1, 'md')
    else 
                if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, 'Welcome msg not saved!', 1, 'md')
else 
         send(msg.chat_id_, msg.id_, 1, '● - `خطایی رخ داد!\n متنی براے خوش آمدگویی گروه ثبت نشده است` ⚠️', 1, 'md')
end
	end
	end
	-----------------------------------------------------------------------------------------------
          local text = msg.content_.text_:gsub('فیلتر','bad')
    ...
    local name = string.sub(filters[2], 1, 50)
		  ...
		  send(msg.chat_id_, msg.id_, 1, "*New Word baded!*\n--> `"..name.."`", 1, 'md')
  		  ...
  		  send(msg.chat_id_, msg.id_, 1, "● - کلمہ فیلترشده جدید ثبت شد` ✔ \n عبارت است از:\n `"..name.."`️", 1, 'md')
end
	end
	-----------------------------------------------------------------------------------------------
          local text = msg.content_.text_:gsub('حذف فیلتر','unbad')
    ...
    local name = string.sub(rws[2], 1, 50)
		  ...
		  send(msg.chat_id_, msg.id_, 1, "`"..rws[2].."` *Removed From baded List!*", 1, 'md')
  		  ...
  		  send(msg.chat_id_, msg.id_, 1, " ● - کلمه از لیست فیلتر #خارج شد \n کلمه عبارت است از:\n "..rws[2].." ❌⚠️", 1, 'md')
end
	end 
	-----------------------------------------------------------------------------------------------
          local text = msg.content_.text_:gsub('ارسال','bc')
		  ...
		  send(gpss[i], 0, 1, rws[2], 1, 'md')
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                   send(msg.chat_id_, msg.id_, 1, '*Done*\n_Your Msg Send to_ `'..gps..'` _Groups_', 1, 'md')
                     ...
                     send(msg.chat_id_, msg.id_, 1, '●-#موفقیت در ارسال✅ \n پیام شما بہ `'..gps..'` گروه #باموفقیت ارسال شد√️', 1, 'md')
end
	end
	-----------------------------------------------------------------------------------------------
	if text:match("^[Gg][Rr][Oo][Uu][Pp][Ss]$") and is_admin(msg.sender_user_id_, msg.chat_id_) or text:match("^وضعیت ربات$") and is_admin(msg.sender_user_id_, msg.chat_id_) then
    ...
    local allmgs = database:get("bot:allmsgs")
                if database:get('lang:gp:'..msg.chat_id_) then
                   ...
                   send(msg.chat_id_, msg.id_, 1, '#انجام شد✅\n آمار دریافتی:\n گپ ها:⬅️ `'..gps..'` \n کاربران:⬅️ `'..users..'` \n چت هاے دریافتے:⬅️ `'..allmgs..'`\n #موفق باشید', 1, 'md')
end
	end
	
if  text:match("^[Mm][Ss][Gg]$") or text:match("^چت دریافتی$") and msg.reply_to_message_id_ == 0  then
local user_msgs = database:get('user:msgs'..msg.chat_id_..':'..msg.sender_user_id_)
                if database:get('lang:gp:'..msg.chat_id_) then
      send(msg.chat_id_, msg.id_, 1, "*Msgs : * `"..user_msgs.."`", 1, 'md')
    else 
      send(msg.chat_id_, msg.id_, 1, "● - `چت هاے دریافتی ⬅️ :` *"..user_msgs.."*", 1, 'md')
end
	end
	-----------------------------------------------------------------------------------------------
    ...
    if lockpt[2] == "edit" or TSHAKEPT[2] == "ویرایش" then
              if not database:get('editmsg'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                 ...
                 send(msg.chat_id_, msg.id_, 1, 'ویرایش چت درگروه #باموفقیت ممنوع شد🔐 ☑️', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                 ...
                 send(msg.chat_id_, msg.id_, 1, 'ویرایش چت از قبل فعال بود🔐 ☑️', 1, 'md')
                end
              end
            end
   if lockpt[2] == "bots" or TSHAKEPT[2] == "ربات" then
              if not database:get('bot:bots:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                 ...
                 send(msg.chat_id_, msg.id_, 1, 'ورود ربات بہ گروه #باموفقیت ممنوع شد🔐 ☑️', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                 ...
                 send(msg.chat_id_, msg.id_, 1, 'ورودربات بہ گروه از قبل ممنوع می باشد🔐 ☑️', 1, 'md')
                end
              end
            end
            	  if lockpt[2] == "flood ban" or TSHAKEPT[2] == "حساسیت مسدودیت" then
                if database:get('anti-flood:'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                   send(msg.chat_id_, msg.id_, 1, '_> *Flood ban* has been *unlocked*', 1, 'md')
                 else
                  send(msg.chat_id_, msg.id_, 1, 'حساسیت مسدودیت #ممنوع میباشد!🔐☑️', 1, 'md')
                  end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                 ...
                 send(msg.chat_id_, msg.id_, 1, 'حساسیت مسدودیت از قبل #ممنوع میباشد√🔐 ☑️', 1, 'md')
                end
              end
            end
            	  if lockpt[2] == "flood mute" or TSHAKEPT[2] == "حساسیت بیصدا" then
                if database:get('anti-flood:warn'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                   send(msg.chat_id_, msg.id_, 1, '_> *Flood mute* has been *unlocked*', 1, 'md')
                 else
                  send(msg.chat_id_, msg.id_, 1, 'حساسیت بیصدا #ممنوع میباشد!🔐☑️', 1, 'md')
                  end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                 ...
                 send(msg.chat_id_, msg.id_, 1, 'حساسیت بیصدا از قبل #ممنوع میباشد!🔐 ☑️', 1, 'md')
                end
              end
          end
            	  if lockpt[2] == "flood del" or TSHAKEPT[2] == "حساسیت پاک کردن" then
                if database:get('anti-flood:del'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                   send(msg.chat_id_, msg.id_, 1, '_> *Flood del* has been *unlocked*', 1, 'md')
                 else
                  send(msg.chat_id_, msg.id_, 1, 'حساسیت پاک کردن #ممنوع میباشد!☑️', 1, 'md')
                  end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                 ...
                 send(msg.chat_id_, msg.id_, 1, 'حساسیت پاک کردن از قبل #ممنوع میباشد! ☑️', 1, 'md')
                end
              end
            end
        if lockpt[2] == "pin" and is_owner(msg.sender_user_id_, msg.chat_id_) or TSHAKEPT[2] == "سنجاق" and is_owner(msg.sender_user_id_, msg.chat_id_) then
              if not database:get('bot:pin:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                 send(msg.chat_id_, msg.id_, 1, "_> Pin Has been_ *locked*", 1, 'md')
                else
                 send(msg.chat_id_, msg.id_, 1, 'سنجاق کردن درگروه #ممنوع شد🔐 ☑️', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                 ...
                 send(msg.chat_id_, msg.id_, 1, 'سنجاق کردن درگروه از قبل #ممنوع میباشد! ☑️', 1, 'md')
                end
              end
            end
        if lockpt[2] == "pin warn" and is_owner(msg.sender_user_id_, msg.chat_id_) or TSHAKEPT[2] == "سنجاق هشدار" and is_owner(msg.sender_user_id_, msg.chat_id_) then
              if not database:get('bot:pin:warn'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                 send(msg.chat_id_, msg.id_, 1, "_> Pin warn Has been_ *locked*", 1, 'md')
                else
                 send(msg.chat_id_, msg.id_, 1, 'سنجاق کردن در گروه #ممنوع شد🔐\n حالت هشدار فعال شد! ☑️', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                 ...
                 send(msg.chat_id_, msg.id_, 1, 'سنجاق کردن از قبل در گروه #ممنوع میباشد!🔐\n هشدار از قبل فعال شده بود☑️', 1, 'md')
                end
              end
            end
          end
	...
	local TSHAKEUN = {string.match(text, "^(بازکردن) (.*)$")} 
              ...
              if database:get('editmsg'..msg.chat_id_) then
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                 ...
                 send(msg.chat_id_, msg.id_, 1, 'ویرایش چت در گروه از قبل #باز میباشد! ⚠️', 1, 'md')
                end
              end
            end
              ...
              if database:get('bot:bots:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                  ...
                  send(msg.chat_id_, msg.id_, 1, 'ورود ربات در گروه #آزاد شد!⚠️', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                 ...
                 send(msg.chat_id_, msg.id_, 1, 'ورود ربات بہ گروه از قبل #آزاد میباشد! ⚠️', 1, 'md')
                end
              end
            end
            	  if unlockpt[2] == "flood ban" or TSHAKEUN[2] == "حساسیت مسدودیت" then
                if not database:get('anti-flood:'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                   send(msg.chat_id_, msg.id_, 1, '_> *Flood ban* has been *unlocked*', 1, 'md')
                 else
                  send(msg.chat_id_, msg.id_, 1, 'حساسیت مسدودیت #آزاد شد⚠️', 1, 'md')
                  end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                 ...
                 send(msg.chat_id_, msg.id_, 1, 'حساسیت مسدودیت از قبل #آزاد میباشد!⚠️', 1, 'md')
                end
              end
            end
            	  if unlockpt[2] == "flood mute" or TSHAKEUN[2] == "حساسیت بیصدا" then
                if not database:get('anti-flood:warn'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                   send(msg.chat_id_, msg.id_, 1, '_> *Flood mute* has been *unlocked*', 1, 'md')
                 else
                  send(msg.chat_id_, msg.id_, 1, 'حساسیت بیصدا در گروه #آزاد شد!⚠️', 1, 'md')
                  end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                 ...
                 send(msg.chat_id_, msg.id_, 1, 'حساسیت بیصدا از قبل #آزاد میباشد!⚠️', 1, 'md')
                end
              end
          end
            	  if unlockpt[2] == "flood del" or TSHAKEUN[2] == "حساسیت پاک کردن" then
                if not database:get('anti-flood:del'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                   send(msg.chat_id_, msg.id_, 1, '_> *Flood del* has been *unlocked*', 1, 'md')
                 else
                  send(msg.chat_id_, msg.id_, 1, 'حساسیت پاک کردن #آزاد شد!⚠️', 1, 'md')
                  end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                 ...
                 send(msg.chat_id_, msg.id_, 1, 'حساسیت پاک کردن از قبل #آزاد شده بود!⚠️', 1, 'md')
                end
              end
            end
                if unlockpt[2] == "pin" and is_owner(msg.sender_user_id_, msg.chat_id_) or TSHAKEUN[2] == "سنجاق" and is_owner(msg.sender_user_id_, msg.chat_id_) then
              if database:get('bot:pin:mute'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                    send(msg.chat_id_, msg.id_, 1, "_> Pin Has been_ *Unlocked*", 1, 'md')
                else
                  send(msg.chat_id_, msg.id_, 1, 'سنجاق کردن در گروه #آزاد شد⚠️', 1, 'md')
                end
                ...
                if database:get('lang:gp:'..msg.chat_id_) then
                 ...
                 send(msg.chat_id_, msg.id_, 1, 'سنجاق کردن در گروه از قبل #آزاد میباشد!⚠️', 1, 'md')
                end
              end
            end
                if unlockpt[2] == "pin warn" and is_owner(msg.sender_user_id_, msg.chat_id_) or TSHAKEUN[2] == "سنجاق هشدار" and is_owner(msg.sender_user_id_, msg.chat_id_) then
              if database:get('bot:pin:warn'..msg.chat_id_) then
                if database:get('lang:gp:'..msg.chat_id_) then
                    send(msg.chat_id_, msg.id_, 1, "_> Pin warn Has been_ *Unlocked*", 1, 'md')
                else
                send(msg.chat_id_, msg.id_, 1, 'سنجاق کردن در گروه #آزاد شد√\n حالت هشدار #غیرفعال شد!⚠️', 1, 'md')
                end
	...
	-----------------------------------------------------------------------------------------------
          local text = msg.content_.text_:gsub('قفل ثانیه ای','lock all s')
	...
	local mutept = {string.match(text, "^[Ll][Oo][Cc][Kk] [Aa][Ll][Ll] [Ss] (%d+)$")}
         ...
         send(msg.chat_id_, msg.id_, 1, '_> Group muted for_ *'..mutept[1]..'* _seconds!_', 1, 'md')
              ...
              send(msg.chat_id_, msg.id_, 1, "انجام شد\n همہ ے قفل ها در گروه بہ مدت ["..mutept[1].."] ثانیہ فعال شد! 🔐❌", 'md')
end
	end

          local text = msg.content_.text_:gsub('قفل ساعتی','lock all h')
    if text:match("^[Ll][Oo][Cc][Kk] [Aa][Ll][Ll] [Hh]  (%d+)$") and is_mod(msg.sender_user_id_, msg.chat_id_) then
        ...
        local num = tonumber(num1)
            database:setex('bot:muteall'..msg.chat_id_, num, true)
              ...
              send(msg.chat_id_, msg.id_, 1, "انجام شد!\nگروه بہ مدت ["..mutept[1].."] ساعت #قفل شد!🔐❌", 'md')
end
     end
	-----------------------------------------------------------------------------------------------
  	if text:match("^[Ll][Oo][Cc][Kk] (.*)$") and is_mod(msg.sender_user_id_, msg.chat_id_) or text:match("^قفل (.*)$") and is_mod(msg.sender_user_id_, msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'همہ ے ویژگے ها در گروه #ممنوع شد! ☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'همہ ے ویژگے ها از قبل #ممنوع میباشند!☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "all warn" or TSHAKE[2] == "همه هشدار" then
	  if not database:get('bot:muteallwarn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> mute all warn has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, 'تمام ویژگے هاے گروه #ممنوع شد\n هشدار #فعال شد☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'تمام ویژگے هاے گروه از قبل #ممنوع شده بود\n هشداد از قبل #فعال میباشد!☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "all ban" or TSHAKE[2] == "همه مسدودیت" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'ارسال #متن در گروه #ممنوع شد', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, '️ارسال متن در گروه #ممنوع شده بود', 1, 'md')
      end
      end
      end
      if mutept[2] == "text ban" or TSHAKE[2] == "متن مسدودیت" then
	  if not database:get('bot:text:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> Text ban has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, 'ارسال #متن در گروه #ممنوع شد\n حالت مسدودیت فعال میباشد!☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'ارسال #متن در گروه #ممنوع شده بود\n حالت مسدودیت از قبل فعال میباشد!☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "text warn" or TSHAKE[2] == "متن هشدار" then
	  if not database:get('bot:text:warn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> Text Warn has been_ *Locked*', 1, 'md')
      else
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'ارسال #متن در گروه #ممنوع شد\n حالت هشدار ازقبل #فعال میباشد! ☑️', 1, 'md')
      end
      end
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'ارسال کیبورد شیشہ اے در گروه #ممنوع شد!☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'ارسال کیبورد شیشہ اے در گروه #ممنوع شده بود!☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "inline ban" or TSHAKE[2] == "اینلاین مسدودیت" then
	  if not database:get('bot:inline:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> inline ban has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, 'ارسال کیبورد شیشہ اے در گروه #ممنوع شد!\n حالت مسدودیت فعال میباشد!☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'ارسال کیبورد شیشہ اے در گروه #ممنوع شده بود!\n حالت مسدودیت فعال میباشد!☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "inline warn" or TSHAKE[2] == "اینلاین هشدار" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'ارسال تصاویر در گروه #ممنوع شد☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'ارسال تصاویر در گروه #ممنوع شده بود!☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "photo ban" or TSHAKE[2] == "عکس مسدودیت" then
	  if not database:get('bot:photo:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> photo ban has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, 'ارسال تصاویر در گروه #ممنوع شد!\n حالت مسدودیت #فعال میباشد!☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'ارسال تصاویر در گروه #ممنوع شده بود!\n حالت هشدار #فعال میباشد!☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "photo warn" or TSHAKE[2] == "عکس هشدار" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'ارسال ویدیو در گروه #ممنوع شد!☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'ارسال ویدیو در گروه #ممنوع شده بود!☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "video ban" or TSHAKE[2] == "ویدیو مسدودیت" then
	  if not database:get('bot:video:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> video ban has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, 'ارسال ویدیو در گروه #ممنوع شد!\n حالت مسدودیت #فعال میباشد! ☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'ویدیو در گروه #ممنوع شده بود!\nحالت مسدودیت #فعال میباشد!☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "video warn" or TSHAKE[2] == "ویدیو هشدار" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'ارسال ویدیو در گروه #ممنوع شده بود!\n حالت هشدار #فعال میباشد! ☑️', 1, 'md')
      end
      end
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'ارسال گیف در گروه #ممنوع شد!☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'ارسال گیف در گروه #ممنوع میباشد!☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "gif ban" or TSHAKE[2] == "گیف مسدودیت" then
	  if not database:get('bot:gifs:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> gifs ban has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, 'ارسال گیف در #گروه ممنوع شد!\n حالت مسدودیت #فعال میباشد!☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'ارسال گیف درگروه #ممنوع میباشد!\n حالت مسدودیت #فعال میباشد! ☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "gif warn" or TSHAKE[2] == "گیف هشدار" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'ارسال گیف در گروه #ممنوع میباشد!\n حالت هشدار #فعال میباشد! ☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "music" or TSHAKE[2] == "موسیقی" then
	  if not database:get('bot:music:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> music has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, 'ارسال موسیقی در گروه #ممنوع شد! ☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'ارسال موسیقی در گروه #ممنوع میباشد!☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "music ban" or TSHAKE[2] == "موسیقی مسدودیت" then
	  if not database:get('bot:music:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> music ban has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, 'ارسال موسیقی در گروه #ممنوع شد!\n حالت مسدودیت #فعال شد! ☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'ارسال موسیقی در گروه #ممنوع شده بود!\n حالت مسدودیت #فعال میباشد!☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "music warn" or TSHAKE[2] == "موسیقی هشدار" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'ارسال صدا در گروه #ممنوع شد!☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'ارسال صدا در گروه #ممنوع شده بود!☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "voice ban" or TSHAKE[2] == "صدا مسدودیت" then
	  if not database:get('bot:voice:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> voice ban has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, 'ارسال صدا در گروه #ممنوع میباشد!\n حالت مسدودیت #فعال میباشد! ☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'ارسال صدا درگروه #ممنوع شده بود!\n حالت مسدودیت #فعال شده بود! ☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "voice warn" or TSHAKE[2] == "صدا هشدار" then
	  if not database:get('bot:voice:warn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> voice ban has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, 'ارسال صدا در گروه #ممنوع شد!\n حالت هشدار #فعال میباشد!☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'ارسال لینک در گروه #ممنوع شد!☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'ارسال لینک در گروه #ممنوع شده بود!☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "links ban" or TSHAKE[2] == "لینک مسدودیت" then
	  if not database:get('bot:links:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> links ban has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, 'ارسال لینک در گروه #ممنوع شد!\n حالت مسدودیت #فعال میباشد!☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'ارسال لینک در گروه #ممنوع شده بود!\n حالت مسدودیت #فعال میباشد!☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "links warn" or TSHAKE[2] == "لینک هشدار" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'ارسال لینک در گروه #ممنوع میباشد!\n حالت هشدار #فعال میباشد! ☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "location" or TSHAKE[2] == "مکان" then
	  if not database:get('bot:location:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> location has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, 'ارسال مختصات جغرافیایی در گروه #ممنوع میباشد! ☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, 'ارسال مختصات جغرافیایی در گروه از قبل #ممنوع میباشد! ☑️', 1, 'md')
      end
      end
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "english" or TSHAKE[2] == "انگلیسی" then
	  if not database:get('bot:english:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> english has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, '● - ارسال کلمات `[انگلیسی]` در گروه #باموفقیت ممنوع شد! ☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, '● - ارسال کلمات `[انگلیسی]` در گروه از قبل #ممنوع میباشد! ☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "english ban" or TSHAKE[2] == "مسدودیت انگلیسی" then
	  if not database:get('bot:text:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> english ban has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, '● - ارسال کلمات `[انگلیسی]` در گروه #باموفقیت ممنوع میباشد!\nحالت مسدودیت #فعال میباشد! ☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, '● - ارسال کلمات `[انگلیسی]` در گروه از قبل #ممنوع میباشد!\nحالت مسدودیت از قبل #فعال میباشد! ☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "english warn" or TSHAKE[2] == "هشدار انگلیسی" then
	  if not database:get('bot:english:warn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> english ban has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, '● - ارسال کلمات `[انگلیسی]` در گروه #باموفقیت ممنوع شد!\nحالت هشدار #فعال میباشد! ☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "spam del" or TSHAKE[2] == "هرزنامه" then
	  if not database:get('bot:spam:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> spam has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, '● - ارسال #هرزنامه در گروه #باموفقیت ممنوع میباشد! ☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, '● - ارسال #هرزنامه در گروه از قبل #ممنوع میباشد! ☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "spam warn" or TSHAKE[2] == "هشدار هرزنامه" then
	  if not database:get('bot:spam:warn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> spam ban has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, '● - ارسال #هرزنامه در گروه #باموفقیت ممنوع شد!\nحالت هشدار #فعال میباشد! ☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, '● - ارسال #هرزنامه در گروه از قبل #ممنوع میباشد!\nحالت هشدار از قبل #فعال میباشد! ☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "sticker" or TSHAKE[2] == "استیکر" then
	  if not database:get('bot:sticker:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> sticker has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, '● - ارسال #استیکر در گروه #باموفقیت ممنوع شد! ☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, '● - ارسال #استیکر در گروه از قبل #ممنوع میباشد! ☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "sticker ban" or TSHAKE[2] == "مسدودیت استیکر" then
	  if not database:get('bot:sticker:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> sticker ban has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, '● - ارسال #استیکر در گروه #باموفقیت ممنوع شد!\nحالت مسدودیت در گروه #فعال میباشد! ☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, '● - ارسال استیکر در گروه از قبل #ممنوع میباشد!\nحالت مسدودیت در گروه از قبل #فعال میباشد! ☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "sticker warn" or TSHAKE[2] == "هشدار استیکر" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, '● - ارسال #فایل در گروه از قبل #ممنوع میباشد! ☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "file ban" or TSHAKE[2] == "مسدودیت فایل" then
	  if not database:get('bot:document:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> file ban has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, '● - ارسال #فایل در گروه #باموفقیت ممنوع شد!\nحالت مسدودیت فعال میباشد! ☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, '● - ارسال #فایل در گروه از قبل #ممنوع میباشد!\nحالت مسدودیت از قبل #فعال میباشد! ☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "file warn" or TSHAKE[2] == "هشدار فایل" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "markdown" or TSHAKE[2] == "فونت" then
	  if not database:get('bot:markdown:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> markdown has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, '● - ارسال کلمات #فونت در گروه #باموفقیت ممنوع شد! ☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, '● - ارسال کلمات #فونت در گروه از قبل #ممنوع میباشد! ☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "markdown ban" or TSHAKE[2] == "مسدودیت فونت" then
	  if not database:get('bot:markdown:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> markdown ban has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, '● - ارسال کلمات #فونت در گروه #باموفقیت ممنوع شد!\nحالت مسدودیت #فعال میباشد! ☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, '● - ارسال کلمات #فونت در گروه از قبل #ممنوع میباشد!\nحالت مسدودیت از قبل #فعال میباشد! ☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "markdown warn" or TSHAKE[2] == "هشدار فونت" then
	  if not database:get('bot:markdown:warn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> markdown ban has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, '● - ارسال کلمات #فونت در گروه #باموفقیت ممنوع میباشد!\nحالت هشدار #فعال میباشد! ☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, '● - ارسال کلمات #وفنت در گروه از قبل #ممنوع میباشد!\nحالت هشدار از قبل #فعال میباشد! ☑️', 1, 'md')
      end
      end
    end
    
	  if mutept[2] == "service" or TSHAKE[2] == "سرویس" then
	  if not database:get('bot:tgservice:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> tgservice has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, '● - ارسال `سرویس های تلگرامی` در گروه #باموفقیت ممنوع شد! ☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, '● - ارسال `سرویس های تلگرامی` در گروه ار قبل #ممنوع میباشد! ☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "fwd" or TSHAKE[2] == "فروارد" then
	  if not database:get('bot:forward:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> forward has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, '● - ارسال `[فروارد=نقل قول]` در گروه #باموفقیت ممنوع شد! ☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, '● - ارسال `[فروارد=نقل قول]` در گروه از قبل #ممنوع میباشد! ☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "fwd ban" or TSHAKE[2] == "مسدودیت فروارد" then
	  if not database:get('bot:forward:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> forward ban has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, '● - ارسال `[فروارد=نقل قول]` در گروه #باموفقیت ممنوع شد!\nحالت مسدودیت #فعال میباشد! ☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, '● - ارسال `[فروارد=نقل قول]` در گروه از قبل #ممنوع میباشد!\nحالت مسدودیت از قبل #فعال میباشد! ☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "fwd warn" or TSHAKE[2] == "هشدار فروارد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "cmd" or TSHAKE[2] == "پیام" then
	  if not database:get('bot:cmd:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> cmd has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, '● - ارسال پیام در گروه #باموفقیت ممنوع شد! ☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, '● - ارسال پیام در گروه از قبل #ممنوع میباشد! ☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "cmd ban" or TSHAKE[2] == "مسدودیت پیام" then
	  if not database:get('bot:cmd:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> cmd ban has been_ *Locked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, '● - ارسال پیام در گروه #باموفقیت ممنوع شد!\nحالت مسدودیت #فعال میباشد! ☑️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, '● - ارسال پیام در گروه از قبل #ممنوع میباشد!\nحالت مسدودیت از قبل #فعال میباشد! ☑️', 1, 'md')
      end
      end
      end
      if mutept[2] == "cmd warn" or TSHAKE[2] == "هشدار پیام" then
	...
	local UNTSHAKE = {string.match(text, "^(بازکردن) (.*)$")} 
      if unmutept[2] == "all" or UNTSHAKE[2] == "همه" then
	  if database:get('bot:muteall'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> mute all has been_ *unLocked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, '● - ارسال تمامی موارد در گروه #مجاز شد⚠️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, '● - ارسال تمامی موارد در گروه از قبل #مجاز میباشد! ⚠️', 1, 'md')
      end
      end
      end
      if unmutept[2] == "all warn" or UNTSHAKE[2] == "هشدار همه" then
	  if database:get('bot:muteallwarn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> mute all warn has been_ *unLocked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, '● - ارسال تمامی موارد در گروه #باموفقیت مجاز شد!\nحالت هشدار #غیر فعال میباشد!⚠️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, '● - ارسال تمامی موارد در گروه از قبل #مجاز میباشد!\n حالت هشدار از قبل #غیرفعال میباشد! ⚠️', 1, 'md')
      end
      end
      end
      if unmutept[2] == "all ban" or UNTSHAKE[2] == "مسدودیت همه" then
	  if database:get('bot:muteallban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> mute all ban has been_ *unLocked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, '● - ارسال تمامی موارد در گروه #باموفقیت مجاز شد!\nحالت مسدودیت #غیرفعال شد!⚠️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "text" or UNTSHAKE[2] == "متن" then
	  if database:get('bot:text:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> Text has been_ *unLocked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, '● - ارسال #متن در گروه #باموفقیت مجاز شد!⚠️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, '● - ارسال #متن در گروه از قبل #مجاز میباشد! ⚠️', 1, 'md')
      end
      end
      end
      if unmutept[2] == "text ban" or UNTSHAKE[2] == "مسدودیت متن" then
	  if database:get('bot:text:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> Text ban has been_ *unLocked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, '● - ارسال #متن در گروه #باموفقیت مجاز شد!\nحالت مسدودیت #غیرفعال میباشد!⚠️', 1, 'md')
      end
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, '● - ارسال #متن در گروه از قبل مجاز میباشد!\nحالت مسدودیت از قبل #غیرفعال میباشد! ⚠️', 1, 'md')
      end
      end
      end
      if unmutept[2] == "text warn" or UNTSHAKE[2] == "هشدار متن" then
	  if database:get('bot:text:warn'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> Text ban has been_ *unLocked*', 1, 'md')
      else
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if unmutept[2] == "inline" or UNTSHAKE[2] == "کیبورد شیشه ای" then
	  if database:get('bot:inline:mute'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_> inline has been_ *unLocked*', 1, 'md')
      else
         send(msg.chat_id_, msg.id_, 1, '● -  ارسال `کیبورد شیشه ای` در گروه #باموفقیت مجاز شد!⚠️', 1, 'md')
      end
...
----------------------------------------------------------------------------------------------
  ...
  if database:get('lang:gp:'..msg.chat_id_) then
   ...
   if text:match("^[Ii][Dd][Gg][Pp]$") or text:match("^ايدي المجموعه$") then
	...
	-----------------------------------------------------------------------------------------------
  if text == "unlock id" and is_owner(msg.sender_user_id_, msg.chat_id_) or text == "Unlock id" and is_owner(msg.sender_user_id_, msg.chat_id_) or text == "تفعيل ایدی" and is_owner(msg.sender_user_id_, msg.chat_id_) then
  if not database:get('bot:id:mute'..msg.chat_id_) then
  if database:get('lang:gp:'..msg.chat_id_) then
      send(msg.chat_id_, msg.id_, 1, '> *ID is already enabled*️', 1, 'md')
else
      send(msg.chat_id_, msg.id_, 1, '● - `ایدی بالفعل تم تفعيله` ☑️', 1, 'md')
      end
  else
  if database:get('lang:gp:'..msg.chat_id_) then
      send(msg.chat_id_, msg.id_, 1, '> *ID has been enable*️', 1, 'md')
    else
      send(msg.chat_id_, msg.id_, 1, '● - `تم تفعيل ایدی` ☑️', 1, 'md')
       database:del('bot:id:mute'..msg.chat_id_)
      end
    end
    end
  if text == "lock id" and is_owner(msg.sender_user_id_, msg.chat_id_) or text == "Lock id" and is_owner(msg.sender_user_id_, msg.chat_id_) or text == "تعطيل ایدی" and is_owner(msg.sender_user_id_, msg.chat_id_) then
  if database:get('bot:id:mute'..msg.chat_id_) then
  if database:get('lang:gp:'..msg.chat_id_) then
      send(msg.chat_id_, msg.id_, 1, '> *ID is already disabled*️', 1, 'md')
    else
      send(msg.chat_id_, msg.id_, 1, '● - `ایدی بالفعل تم تعطيله` ⚠️', 1, 'md')
      end
    else
  if database:get('lang:gp:'..msg.chat_id_) then
      send(msg.chat_id_, msg.id_, 1, '> *ID has been disable*️', 1, 'md')
    else
      send(msg.chat_id_, msg.id_, 1, '● - `تم تعطيل ایدی` ⚠️', 1, 'md')
